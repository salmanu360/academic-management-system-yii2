...
class StudentParentsInfo extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['first_name', 'cnic','contact_no', 'profession', 'stu_id','gender_type'], 'required'],
            [['stu_id', 'gender_type'], 'integer'],
            [['last_name', 'contact_no', 'profession', 'contact_no2', 'relation', 'office_no','guardian_contact_no'], 'string', 'max' => 30],
    ...
    public function attributeLabels()
    {
        return [
            ...
            'gender_type' => Yii::t('app','Verified by'),
