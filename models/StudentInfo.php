...
class StudentInfo extends \yii\db\ActiveRecord
{
    ...
    public $classid; //genreal reports
     public $password;
   ...
   // public $stop;
    ...
    {
        return [
            [['session_id','user_id', 'fk_branch_id', 'dob', 'gender_type', 'shift_id', 'class_id', 'section_id','religion_id','location1', 'country_id', 'province_id', 'city_id','avail_sibling_discount'], 'required'],
            // [['user_id', 'fk_branch_id', 'dob', 'gender_type', 'shift_id', 'class_id', 'section_id','fk_fee_plan_type','religion_id'], 'required', 'on' => 'admission'],
            [['password'],'required', 'on' => 'change'],
            ...
            [['dob', 'registration_date','fee_generation_date','monthly_fee_gen_date','avail_sibling_discount','roll_no','tribe'], 'safe'],
            [['parent_status'], 'boolean'],
            [['contact_no'], 'string', 'max' => 200],
    ...
    public function getParentsInfo()
    {
