...
class RefSection extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['status'], 'string'],
            [['title'], 'unique','message'=>'This section has already alocated to this class', 'targetAttribute' => ['title', 'class_id']],

            /*[['title', 'fk_group_id'], 'unique', 'targetAttribute' => ['title', 'fk_group_id']],*/
