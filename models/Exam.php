...
class Exam extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['id', 'fk_class_id', 'fk_subject_id', 'fk_exam_type', 'total_marks'], 'required'],
            [['id', 'fk_class_id', 'fk_group_id', 'fk_subject_id', 'fk_exam_type', 'passing_marks','fk_subject_division_id','do_not_create'], 'integer'],
            [['start_date', 'end_date','skip_in_schedule'], 'safe'],
