...
use app\models\search\ExpenseCategorySearch;
...
class ExpenseCategoryController extends Controller
{
    ...
    public function actionCreate()
    {
        ...
        if($request->isAjax){
            ...
            */
            ...
            if($request->isGet){
                return [
                    'title'=> "Create new ExpenseCategory",
                ...
                return [
                    ...
                    'title'=> "Create new ExpenseCategory",
                    'content'=>'<span class="text-success">Create ExpenseCategory success</span>',
                    'footer'=> Html::button('Close',['class'=>'btn btn-default pull-left','data-dismiss'=>"modal"]).
    ...
    public function actionUpdate($id)
    {
        ...
        if($request->isAjax){
            ...
            */
            ...
            if($request->isGet){
                return [
                    'title'=> "Update ExpenseCategory #".$id,
    ...
    /**
     * Delete an existing ExpenseCategory model.
     * For ajax request will return json object
    ...
    public function actionDelete($id)
    {
     ...
     /**
     * Delete multiple existing ExpenseCategory model.
     * For ajax request will return json object
     * and for non-ajax request if deletion is successful, the browser will be redirected to the 'index' page.
     * @param integer $id
     * @return mixed
