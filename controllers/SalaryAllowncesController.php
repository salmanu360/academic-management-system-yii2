...
class SalaryAllowncesController extends Controller
{
    ...
    public function actionGetStages(){
        ...
        echo "<option selected='selected'>Select Pay Head Type</option>";
    ...
    public function actionCreate()
    {
        ...
        if($request->isAjax){
            ...
            */
            ...
            if($request->isGet){
                return [
                    'title'=> "Create new Pay Allownces",
                ...
                return [
                    ...
                    'title'=> "Create new Pay Allownces",
                    'content'=>'<span class="text-success">Create Pay Allownces success</span>',
                    'footer'=> Html::button('Close',['class'=>'btn btn-default pull-left','data-dismiss'=>"modal"]).
