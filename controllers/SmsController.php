...
class SmsController extends Controller
{
    ...
    {
        $model = $this->findModel($id);
        $model->purchased_request_date=date('Y-m-d H:i:s');
        $model->save(false);
        \Yii::$app->getSession()->setFlash('success', 'Your request has been received, one of our staff memeber will contact you.');
