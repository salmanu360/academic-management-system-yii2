...
class SubjectsController extends Controller
{
    ...
    {    
        ...
        if(count(Yii::$app->request->get())== 0 ){
            ...
            if(empty(Yii::$app->request->get('SubjectsSearch')['fk_class_id'])){
                $searchModel->id = 0;
            }
        }
    ...
    public function actionGetGroups(){
        if(yii::$app->user->isGuest){
            ...
            if(yii::$app->request->isAjax){
                ...
                $groupData = RefGroup::find()->where(['fk_branch_id'=> Yii::$app->common->getBranch(),'fk_class_id'=>$id,'status'=>'active'])->all();
