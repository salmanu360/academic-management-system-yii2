...
class HelloController extends Controller
{
    ...
    public function actionMake(){
        ...
        $GetWorkingdays=WorkingDays::find()->select('title')->where(['is_active'=>1,'fk_branch_id'=>9,'title'=>date("D")])->one();
...
//        fclose($f);
    ...
    public function actionStu(){
        ...
        $GetWorkingdays=WorkingDays::find()->select('title')->where(['is_active_stu'=>1,'fk_branch_id'=>9,'title'=>date("D")])->one();
        $day=$GetWorkingdays->title;
