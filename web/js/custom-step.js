            ...
            success: function(data)
            {
                if(data.status == 1){
                    if(data.detail == 1 || data.detail >1){
                        ...
                        inputDetail.closest('.form-group').find('.help-block').html('Registration Already Exists.');
...
$(document).on('click','#add-discount-head',function (e) {
    ...
    //alert(transportFare);
    var hostelFare   = 0;//$('#total-hostel-fare').data('totalhostel');
...
$(document).ready(function(){
    $(document).on('click','#stuadmissionform',function(){
               var classId     = $('#class-id').val();
                var sectionId   = $('#section-id').val();
                var fatherCnic  = $('input[name="StudentParentsInfo[cnic]"]').val();
                var registeration   = $('#registeration').val();
                var dobdate   = $('#dobdate').val();
                var firstname  = $('#firstnamePersonnel').val();
                var fatherName  = $('#fatherName').val();
                var fatherContact  = $('#fatherContact').val();
                var feeplanid  = $('#fee-plan-id').val();
                var fatherProfession  = $('#fatherProfession').val();
                var countryStudent  = $('.countryError').val();
                var provinceError  = $('.provinceError').val();              
                var DistrictError  = $('.DistrictError').val();              
                var session  = $('.sessionAdmission').val();
                var CityError  = $('.CityError').val();              
                
                if(session ==''){
                    $('.errorSession').html('Sesssion cannot be blank');
                    return false;
                }else{
                    $('.errorSession').html('');
                }
                if(fatherCnic ==''){
                    $('.errorCnic').html('CNIC cannot be blank');
                    return false;
                }
                else{
                    $('.errorCnic').html('');
                ...
                if(classId =='Select Class'){
                    $('.errorClass').html('Class cannot be blank');
                    return false;
                ...
                if(sectionId =='Loading ...'){
                    $('.errorSection').html('Section cannot be blank');
                    return false;
                }else{
                    $('.errorSection').html('');
                }
                ...
                if(registeration ==''){
                    $('.errorRegisteration').html('Registeration cannot be blank');
                    return false;
                }else{
                    $('.errorRegisteration').html('');
                }
                if(dobdate ==''){
                    $('.errorDOB').html('DOB cannot be blank');
                    return false;
                }else{
                    $('.errorDOB').html('');
                }if(firstname ==''){
                    $('.errorFirstname').html('First Name cannot be blank');
                    return false;
                }else{
                    $('.errorFirstname').html('');
                }if(countryStudent == ''){
                    $('.errorCountry').html('Country cannot be blank');
                    return false;
                   
                }else{
                    $('.errorCountry').html('');
                }if(provinceError =='Select Provinces'){
                    $('.errorprovince').html('Province cannot be blank');
                    return false;
                ...
                if(DistrictError =='Select District'){
                    $('.errorDistrict').html('District cannot be blank');
                    return false;
                   
                }else{
                    $('.errorDistrict').html('');
                }if(CityError =='Select City'){
                    $('.errorCity').html('City cannot be blank');
                    return false; 
                }else{
                    $('.errorCity').html('');
                }
                if(fatherName ==''){
                    $('.errorFathername').html('Father Name cannot be blank');
                    return false;
                }else{
                    $('.errorFathername').html('');
                }if(fatherContact ==''){
                    $('.errorFatherContact').html('Father Contact # cannot be blank');
                    return false;
                }else{
                    $('.errorFatherContact').html('');
                }if(fatherProfession ==''){
                    $('.errorfatherProfession').html('Father Profession cannot be blank');
                    return false;
                }else{
                    $('.errorfatherProfession').html('');
                }if(feeplanid ==''){
                    $('.errorfeeInstalments').html('Fee Installments cannot be blank');
                    return false;
                }else{
                    $('.errorfeeInstalments').html('');
                }                         
    });
});
