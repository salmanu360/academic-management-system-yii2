...
use app\models\EmployeeInfo;
     ...
     $employeelatecomingCount=EmployeeAttendance::find()->where(['fk_empl_id'=>$empid,'leave_type'=>'late'])->all();
 ...
 <div class="panel panel-default">
                        <div class="panel-heading">
                            <h4 class="panel-title">Generate Pay Slip</h4>
                        </div>
    ...
    <thead>
      ...
      <tr class="info">
       ...
       <?php 
        ...
        if(empty($latecmrplcy)){$latecmrplcy=0;}else{
        $latecmrplcy= $leavequery->latecommer_policy;
       ...
       //echo $latecmrplcy;die;
       //$ttlatecomng=$latecomngcount/$latecmrplcy;
      
       // $ttlatecomng=$latecmrplcy/$latecomngcount;
       $ttlatecomng=$latecomngcount/$latecmrplcy;
...
<!-- <?php 
/*$grossSalary=$employee_payroll->total_amount;
echo $totaldaysMonth=date('t');
echo '<br>';
echo $uptodateDays=$totaldaysMonth-$totalDayGet;
echo '<br>';
 $totalNetSalary=$grossSalary/$totaldaysMonth*$uptodateDays;
 echo $totalNetSalaryRound=round($totalNetSalary,2);*/
 ?> -->