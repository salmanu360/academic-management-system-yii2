...
?> 
<div class="well" style="background: white"><strong>Update Staff <?php echo $model->user->first_name.' '. $model->user->last_name;?></strong>
<a href="<?php echo Url::to(['/employee'])?>" class="btn btn-primary pull-right">Back</a>
</div>
