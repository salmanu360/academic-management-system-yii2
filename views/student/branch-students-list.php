...
?>
    ...
    <div class="col-md-12">
        <div class="alert alert-warning" id="success-alert" >
            ...
            <strong><i class="fa fa-info"></i> Note! </strong>Please Select Students to promote
        </div>
    </div>
    </div>
    <div class="row">
    <div class="col-md-12">
        ...
        <div class="col-md-3">
        	<br />
            <?=Html::submitButton('Promote',['class'=>'btn btn-success btn-promote-std','id'=>'btn-promote-std','data-url'=>Url::to(['student/save-promoted-student'])])?>
        </div>
    </div>
    </div>
