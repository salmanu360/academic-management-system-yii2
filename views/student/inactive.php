...
$this->title = 'Activate Students'; 
$this->params['breadcrumbs'][] = ['label' => 'Analysis', 'url' => ['/analysis']];
$this->params['breadcrumbs'][] = ['label' => 'Find Students', 'url' => ['/student']];
$this->params['breadcrumbs'][] = ['label' => 'Student Attendance', 'url' => ['/student/calendar']];
$this->params['breadcrumbs'][] = ['label' => 'Admit Students', 'url' => ['/student/admission']];
$this->params['breadcrumbs'][] = ['label' => 'Inactive Students', 'url' => ['/student/inactive-student']];
$this->params['breadcrumbs'][] = ['label' => 'Promote Students', 'url' => ['/student/promote-students']];
$this->params['breadcrumbs'][] = ['label' => 'Change Student Section', 'url' => ['/student/shuffle-students']];
?>
...
<div class="row">
        <div class="col-xs-12">
          <h2 class="page-header">
            <i class="fa fa-user"></i> Activate Students.
            <small class="pull-right">Date: <?php echo date("d/m/Y") ?></small>
          </h2>
        </div>
        </div>
<div class="student-info-index responsive"> 
