...
<div class="alert alert-warning"><h5s style="color:black">If don't want to give discount on all fee heads, then do not click on save button</h5></div>
...
<div class="box-primary">
 ...
 <table class="table table-striped">
              ...
              <tbody>
                ...
                $discount_sibling=0;
                $amount_head=0;
                // echo '<pre>';print_r($getFeeDetails);
              ...
              if($getHead->promotion_head == 1){
                ...
                // skip promotion for naew admission end
                  ...
                  if(!empty($parent_cnic)){
                    //echo $student_info->avail_sibling_discount;
                    //echo $cnic_count+1;
                    //echo $cnic_count;
                      /*if sibling is more than provided in settings*/
                      // $cnic_count+1 // old
                      if(($cnic_count) >= $settings->sibling_no_childs  && $getFeeDetails->fk_fee_head_id == $getHead->id && $getHead->sibling_discount ==1 && $student_info->avail_sibling_discount ==1){
