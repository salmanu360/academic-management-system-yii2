  ...
  <div class="row">
    ...
    <div class="table-responsive">
      ...
      <table class="table table-striped table-bordered table-condensed" cellspacing="0" width="100%"> 
        <!--remove id id="calender_section_bot" -->
        <tr class="name_head">
          <th class="first">Full Name</th>
          <?php 
                $dayCount = 1; 
...
<span class="leaveid at_sp at_leave" id="emp_<?php echo $q->stu_id.date('d',strtotime($currentDate))?>">L</span>
