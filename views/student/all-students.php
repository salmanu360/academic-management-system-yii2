...
<div class="student-info-index"> 
    ...
    'panel' => [
        'heading'=>'<h3 class="panel-title"><i class="glyphicon glyphicon-user"></i> All Students</h3>',
        'type'=>'info',
        ...
        'columns' => [
            ...
            [
             ...
             'value'=>function($data){
             	...
             	//return $data->student->stu_id;
             	return Yii::$app->common->getStudentByUserId($data->id);
             	//return $data->student->user_id;
             	//return Yii::$app->common->getParentName($studentInfo['stu_id']);
             }
            ],
            // 'email:email',
            // 'auth_key',
