   ...
   <div class="box box-default">
        <div class="box-header with-border">
          ...
          <button type="button" class="btn btn-box-tool" data-widget="collapse"><i class="fa fa-minus"></i></button>
            <a href="<?= Url::to(['student/empty-form-pdf']) ?>" class="btn btn-success btn-sm">
              <i class="fa fa-download"> Download Empty Form</i></a>
          </div>
        </div>
        <!-- /.box-header -->
        <div class="box-body">
      ...
      <!-- /.row -->
        ...
        <div class="row">
         ...
         <div class="box box-default">
        <div class="box-header with-border">
          <h3 class="box-title">Previous Qualification Details (Optional)</h3>
          <div class="box-tools pull-right">
            <button type="button" class="btn btn-box-tool" data-widget="collapse"><i class="fa fa-minus"></i></button>
            <button type="button" class="btn btn-box-tool" data-widget="remove"><i class="fa fa-remove"></i></button>
          </div>
        ...
        <div class="col-md-3">
        <?php
        /*echo $form->field($FeeDetails, 'from_date')->widget(DatePicker::classname(), [
                        'options' => ['value' => date('Y-m-d'),'id'=>'from_date_admission'],
                        'pluginOptions' => [
                            'autoclose'=>true,
                            'format' => 'yyyy-mm-dd',
                            'todayHighlight' => true,
        ...
        <?php
        /*echo $form->field($FeeDetails, 'to_date')->widget(DatePicker::classname(), [
                        'options' => ['id'=>'to_date_admission'],
                        'pluginOptions' => [
                            'autoclose'=>true,
                            'format' => 'yyyy-mm-dd',
                            'todayHighlight' => true,
        ...
        ?>
                        ...
                        <!-- <div class="col-md-4">
                            ...
                            ])->label(Yii::t('app','Fee Installments').'<span style="color:#a94442;"> *</span>'); */?>
                        <label for="" class="errorfeeInstalments" style="color: red"></label>
                        </div> -->
                        <!-- <div class="col-md-8" id="fee-plan-details"></div> -->
                        <div class="col-md-8" id="fee-details"></div>
                    </div>
        </div>
        </div>
        ...
        <div class="row">
         ...
         <span id="showSubmitButtonAdmission" style="display: none">
        <?= Html::submitButton($model->isNewRecord ? 'Enroll Student' : 'Make Changes In Student Admission', ['class' => $model->isNewRecord ? 'btn btn-success' : 'btn btn-primary','id'=>'stuadmissionform']) ?>
        </span>
