           ...
           // ['class' => 'yii\grid\ActionColumn'],
            [
                        ...
                        'buttons' => [
                            ...
                            {
                                return Html::a('<span class="glyphicon glyphicon-eye-open toltip" data-placement="bottom" width="20"  title="View Assignments"></span>', ['assigments/view','id'=>$model->id],['data-pjax'=>"0",'class'=>'btn btn-success btn-xs']);
                            },        
                        ],
                    ],
        ],
