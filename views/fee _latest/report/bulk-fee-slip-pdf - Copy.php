...
for ($itrration=1;$itrration<=$copies;$itrration++) {
    ...
    <div style="border-bottom:1px dashed #3f3c8b;">
        ...
        <h3 style='text-align:center'>Fee Slip for the month
            of <?php echo (date('M-Y', strtotime($Fromdate)) == date('M-Y', strtotime($toDate))) ? date('M-Y', strtotime($Fromdate)) : date('M-Y', strtotime($Fromdate)) . ' - ' . date('M-Y', strtotime($toDate)) ?>
        </h3>
        ...
        <div style="width: 50%; float:left;">
            <table class="customers">
                ...
                <tr>
                    ...
                    <th><strong><?= Yii::$app->common->getStudentCGSection($student_id) ?></strong></th>
                </tr>
            </table>
        </div>
        <!--left panel end-->
            ...
            /*temproary avoid admission fee ends*/
                        ...
                        if($transport_amount>0) {
                            ...
                            <tr>
                                ...
                                <td> <?=$total_transport_arrears?></td>
                                <td><?php   echo $transport_head_amount." x ".$diff." = ".$transport_head_amount*$diff;?> </td>
                            </tr>
                            <?php
                        }
                        ?>
                        ...
                        ?>
                            <tr>
                                ...
                                <td> <?= round($hostel_amount, 0) ?>  </td>
                                <td> <?=$total_hostel_arrears?> </td>
                                <td><?php   echo $hostel_head_amount." x ".$diff." = ".$hostel_head_amount*$diff;?> </td>
                            </tr>
                        ...
                        <tr id="amount-payable">
                            ...
                            <td><?= round($net_amount, 0) ?>  </td>
                            <td></td>
                        </tr>
                        <tr>
                            <th colspan="2">Total Arrears</th>
                            <td><?=$total_arrears+$total_hostel_arrears+$total_transport_arrears?> </td>
                            <td> </td>
                        </tr>
                    </tbody>
                </table>
