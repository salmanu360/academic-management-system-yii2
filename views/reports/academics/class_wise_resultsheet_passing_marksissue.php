    ...
    <div id="class-wise-container" class="table-responsive kv-grid-container">
        ...
        foreach ($query as $student_id=>$marks){
            ...
            echo "</td>";
                ...
                foreach ($marks as $obtained_marks) {
                    echo "<td style='border: 1px solid #0000008f;'>";
                                    if($obtained_marks < $passing_marks){
                                        echo '<span style="color: red;border:1px red solid;padding: 2px;">'.$obtained_marks.'</span>';
                                    }else{
           ...
           // echo number_format($total_marks_obtain, 2, '.', '');
            ...
            if(isset($positions)){
               ...
               // var_dump($positionGet);
                if(!$positionGet){
                   echo "<td>N/A</td>";
                }else{
                echo '<td class="pts" width="20" style="border: 1px solid #0000008f" >'.Yii::$app->common->multidimensional_search($positions, ['student_id'=>$student_id]).'</td>';
            }
        }
            //echo "<tr>";
            $i++;
