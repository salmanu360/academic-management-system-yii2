<?php use yii\helpers\Url; ?>
 <style type="text/css">#pasroutetostop:hover{color:blue;}</style>
                 ...
                 <input type="submit" name="Generate Report" data-zoneid="<?php echo $zoneid;?>" id="overalltransportroute" class="btn btn-primary pull-right" value="Generate Report" data-url=<?php echo Url::to(['reports/getroutewise-pdf']) ?> />
