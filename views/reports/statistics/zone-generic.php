...
use yii\helpers\Url;
 ...
 <input type="submit" name="Generate Report" id="overalltransportzone" class="btn btn-primary pull-right" value="Generate Report" data-url=<?php echo Url::to(['reports/get-zone-generic-pdf']) ?> />
