...
<input type="submit" name="Generate Report" data-zoneid="<?php echo $zoneid;?>" data-route="<?php echo $routeid?>" id="stopwise" class="btn btn-primary pull-right" value="Generate Report" data-url=<?php echo Url::to(['reports/getstop-routewise-pdf']) ?> />
<center><i class="fa fa-refresh fa-spin" id="loading" style="font-size:40px;color:green;display: none"></i></center>
