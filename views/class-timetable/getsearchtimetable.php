 ...
 $this->registerCssFile(Yii::getAlias('@web').'/css/timepicker/bootstrap-datetimepicker.min.css',['depends' => [yii\web\JqueryAsset::className()]]); ?>
   ...
   <?php //echo '<pre>';print_r($subjectsdetails);die; ?>
    ...
    <div class="box-header with-border" style="background: white;color: black;">
        ...
        <input type="submit" data-classid="<?= $classid; ?>" data-groupid="<?= $groupid; ?>" data-subjectid="<?= $subjectid; ?>" name="Generate Report" id="ClassTimetablePdf" class="btn btn-primary pull-right" value="Generate Report" data-url=<?php echo Url::to(['class-timetable/generate-timetable-pdf']) ?> />
    </div>
    <div class="box-body">
    <div class="row">
