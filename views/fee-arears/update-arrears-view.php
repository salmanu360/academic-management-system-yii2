...
<div class="fee-arears-form">
    <?php $form = ActiveForm::begin(['action'=>Url::to(['updateexists-arrears','id'=>base64_encode($model->id)])]); ?>
                <?php
   ...
   echo $form->field($model, 'stu_id')->hiddenInput(['value'=>$model->stu_id])->label(false);
    ...
    <?php
        ...
        $head = ArrayHelper::map(\app\models\FeeHead::find()->where(['branch_id'=>yii::$app->common->getBranch(),'extra_head'=>0,'one_time_payment'=>0])->all(), 'id', 'title');
	...
	<?php if (!Yii::$app->request->isAjax){ ?>
	  	<div class="form-group">
            ...
            <a class="btn btn-danger" href="<?php echo Url::to(['list'])?>">Back</a>
	    </div>
	<?php } ?>
    <?php ActiveForm::end(); ?>
</div>
