                ...
                <div class="header-top pad">
                    ...
                    <?php $actual_link = "http://$_SERVER[HTTP_HOST]$_SERVER[REQUEST_URI]";?>
                        <a href="<?php echo $actual_link;?>">
                            ...
                            <img src="<?= Url::to('@web') . $logo ?>"
                                 alt="<?= Yii::$app->common->getBranchDetail()->name . '-logo' ?>">
                        </a>
                    </div>
                    <div class="search">
                        ...
                        <ul class="notific">
                            ...
                            <li class="p-user">
                                <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button"
                                   ...
                                   <!--<img src="<? /*= Url::to('@web/img/avator.png') */
                                   ?>" alt="User">-->
                                    <img class="img-responsive profile profile-image"
                                         src="<?= $web_path . $imageName ?>" alt="<?= $return_name ?>">
                               </span>
                                    <p>Hello!</p>
                                    <p>
                                        <b>
                                    ...
                                    echo Nav::widget([
                                        ...
                                        'items' => [
                                            ...
                                            ['label' => '<img src="' . Url::to('@web/img/book-icon.png') . '" /> '.Yii::t('app','Login'), 'url' => ['/site/login']]
                                                ...
                                                . Html::submitButton(
                                                    '<img src="' . Url::to('@web/img/db-out.svg') . '" /> Signout',
                                                    ['class' => 'mega-items signout-opt']
                                                )
                                                . Html::endForm()
                                                . '</li>'
                                            ),
                                    ...
                                    echo Nav::widget([
                                        ...
                                        'items' => [
                                            ...
                                            ['label' => '<img src="' . Url::to('@web/img/book-icon.png') . '" /> '.Yii::t('app','Login'), 'url' => ['/site/login']]
                                                ...
                                                . Html::beginForm(['/site/logout'], 'post')
                                                . Html::submitButton(
                                                    '<img src="' . Url::to('@web/img/db-out.svg') . '" /> '.Yii::t('app','Signout'),
                                                    ['class' => 'mega-items signout-opt']
                                                )
                                                . Html::endForm()
                                                . '</li>'
