...
<div class="box box-warning">
	<div class="box-body">
		...
		<div class="row">
			<div class="col-md-3">
				...
				<div class="col-md-3">
					...
					<div class="row">
						<div class="col-md-3">
							<?php echo  $form->field($model, 'quiz_date')->widget(DatePicker::classname(), [
        ...
        <div class="col-md-3">
            <?=$form->field($model, 'total_marks')->textInput(['maxlength' => true,'onkeypress'=>'return event.charCode >= 13 && event.charCode <= 57'])?>
        </div>
        <div class="col-md-3">
            <?=$form->field($model, 'passing_marks')->textInput(['maxlength' => true,'onkeypress'=>'return event.charCode >= 13 && event.charCode <= 57'])?>
        </div>
