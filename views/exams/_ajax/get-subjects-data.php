...
<div class="student-info-index">
    ...
    if (count($dataprovider)> 0) {
            ...
            <table class="table exam-data table-striped">
                ...
                <tr>
                   ...
                   <!-- <th>Class</th>
                    ...
                    <th>Start Date</th>
                    <!-- <th>End Date</th> -->
                    <th class="lst-tr">Skip</th>
                    <th class="lst-tr">Skip Schedule</th>
                    <!--<th>Is Exam</th>-->
                </tr>
                ...
                foreach ($dataprovider as $key => $data) {
                    ...
                    <tr>
                       ...
                       <!--  <td>  <?/*= $form->field($model, 'end_date[' . $key . ']')->widget(DateTimePicker::classname(), [
                        ...
                        <td><?= $form->field($model, 'do_not_create[' . $key . ']')->checkbox()->label(false); ?></td>
                        <td>
                            <?= $form->field($model, 'skip_in_schedule[' . $key . ']')->checkbox(['label' => null])->label(false) ?>
        ...
        <div class="col-md-3">  
            <?= $form->field($modelExamType, 'exam_date')->widget(DatePicker::classname(), [
                'type' => DateTimePicker::TYPE_INPUT,
        ...
        <div class="col-md-4">
            <?= $form->field($modelExamType, 'passing_percentage')->textInput(['type' => 'number','placeholder'=>'For example: 70 %'])->label('Exam Passing Percentage <span style="color:green">(Optional)</span>') ?>
        </div>
        <div class="col-md-12 submit-action">
            <div class="form-group">
                <?= Html::button('Create Exam', ['class' => 'btn btn-success', 'id' => 'save-form']) ?>
