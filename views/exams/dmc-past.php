...
/*$promotedData = ArrayHelper::map(\app\models\StuRegLogAssociation::find()->where(['fk_branch_id'=>Yii::$app->common->getBranch(),'status'=>'active'])->all(), 'class_id', 'title'); */
...
$promotedData=\app\models\StuRegLogAssociation::find()->where(['fk_branch_id'=>yii::$app->common->getBranch()])->one();
    ...
    <section class="invoice">
        ...
        <div class="row">
           <div class="col-sm-9">
            ...
            <div class="col-sm-4 fh_item">
                <input type="hidden" id="subject-url" value="<?=Url::to(['/exams/cgs-dmc-past'])?>">
                <?php
