...
<div class="exam-form"> 
    ...
    <div class="row">
           ...
           <div class="col-sm-10">
            ...
            <?= $form->field($model, 'fk_class_id')->dropDownList($class_array, ['id'=>'class-id','class'=>'classSubjects form-control','prompt' => 'Select '.Yii::t('app','Class').'...']); ?>
        </div>
            <div class="col-sm-4 fh_item">
                <?php
                // Dependent Dropdown
                echo $form->field($model, 'fk_group_id')->widget(DepDrop::classname(), [
                    'options' => ['id'=>'group-id','class'=>'classSubjects form-control'],
                    'pluginOptions'=>[
                        'depends'=>['class-id'],
                        'prompt' => 'Select Group...',
            ...
            <div class="col-sm-4 fh_item">
                ...
                <!-- uncomment this if need section -->
                <!-- <?php
